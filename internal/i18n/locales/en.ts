const en = {
  translation: {
    ...
    move: {
      ...
      foundFiles_one: 'I found {{count}} item(s) matching your query.',
      foundFiles_other: 'I found {{count}} item(s) matching your query.',
      successfullyMoved_one: 'Successfully moved {{count}} item:',
      successfullyMoved_other: 'Successfully moved {{count}} items:',
      skipped_one: 'Skipped {{count}} item (already in destination):',
      skipped_other: 'Skipped {{count}} items (already in destination):',
      failed_one: 'Failed to move {{count}} item:',
    ...
    revert: {
      foundFiles_one: 'I found {{count}} item to revert.',
      foundFiles_other: 'I found {{count}} items to revert.',
      successfullyReverted_one: 'Successfully reverted {{count}} item',
      successfullyReverted_other: 'Successfully reverted {{count}} items',
    ...
    search: {
      ...
      indexingProgress: 'Indexing progress: {{completed}} of {{total}} items completed.',
      indexingCompleted: 'Search index built successfully! {{count}} of {{total}} items indexed.',
      indexedItems: 'Successfully indexed items',
      failedItems: 'Files that failed to items',
    ...
    settings: {
      ...
      add: 'Add',
      testModel: 'Test',
      testModelRunning: 'Testing model...',
      testModelSuccess: 'Model test succeeded',
      testModelFailed: 'Model test failed: {{message}}',
      ...
      searchMatchingPreference: 'Search matching preference',
      searchMatchingPreferenceDesc:
        'Relevant scoring: Uses BM25 algorithm to rank results by relevance. Exact match: Matches exact query terms only when query is wrapped in quotation marks or included tags only.',
