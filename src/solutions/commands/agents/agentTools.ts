...
async function buildBaseAgentTools(): Promise<AgentToolsRecord> {
  const [
    ...
    handlers.NewSession.getNewSessionTool(),
    ...
    handlers.ShowWidget.getShowWidgetTool(),
    handlers.WidgetActionHandler.getWidgetActionTool(),
    handlers.WidgetQueryHandler.getWidgetQueryTool(),
  ...
  return {
    ...
    [ToolName.NEW_SESSION]: newSessionTool,
    ...
    [ToolName.SHOW_WIDGET]: showWidgetTool,
    [ToolName.WIDGET_ACTION]: widgetActionTool,
    [ToolName.WIDGET_QUERY]: widgetQueryTool,
