...
export const addTableColumnSchema = z.object(
  {
    ...
    fromLine: z.number().describe('The starting line number (0-based) of the table to modify.'),
...
export const deleteTableColumnSchema = z.object({
  ...
  position: z
    .number()
    .optional()
    .describe('The position (0-based) where to delete the column. If omitted, deletes at the end.'),
});

export const replaceByLinesSchema = z.object(
  {
