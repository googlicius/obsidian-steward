...
export const TOOL_DEFINITIONS: Record<ToolName, ToolMetaDefinition> = {
  ...
  [ToolName.SHOW_WIDGET]: {
    ...
    guidelines: [
      ...
      'For turn-based widgets where humans and models take turns (games vs AI, poker, chess, etc.), read the "interactive-widget" skill after stateful-widget — it covers registerAction, Definition.md (actions, actors, agent blocks), and validation.',
