export const explanationFragment = `- explanation:
  ...
  - Keep it concise, descriptive, and short
  - Use first-person perspective ("I") when referring to yourself`;

export const confidenceFragment = `- confidence: A number from 0 to 1 indicating your confidence in this interpretation`;
