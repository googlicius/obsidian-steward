...
/**
 * Default intent classifier (embedding loaded from bundled @ai-sdk/openai).
 * Lazily constructed and cached; use {@link getIntentClassifier} instead of importing a singleton.
 */
