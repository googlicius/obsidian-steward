...
class StewardSettingTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    // Max Coverage Bonus setting
    new Setting(searchSettingGroup.settingItems)
      .setName(t('settings.maxCoverageBonus'))
      .setDesc(t('settings.maxCoverageBonusDesc'))
      .addSlider(slider => {
        slider
          .setLimits(0, 2, 0.1)
          .setValue(this.plugin.settings.search.scoring?.maxCoverageBonus ?? 0.5)
          .setDynamicTooltip()
          .onChange(async value => {
            if (!this.plugin.settings.search.scoring) {
              this.plugin.settings.search.scoring = {};
            }
            this.plugin.settings.search.scoring.maxCoverageBonus = value;
            await this.plugin.saveSettings();
          });
      });

    // Filename Match Boost setting
    new Setting(searchSettingGroup.settingItems)
      .setName(t('settings.filenameMatchBoost'))
      .setDesc(t('settings.filenameMatchBoostDesc'))
      .addSlider(slider => {
        slider
          .setLimits(1, 5, 0.1)
          .setValue(this.plugin.settings.search.scoring?.filenameMatchBoost ?? 2.0)
          .setDynamicTooltip()
          .onChange(async value => {
            if (!this.plugin.settings.search.scoring) {
              this.plugin.settings.search.scoring = {};
            }
            this.plugin.settings.search.scoring.filenameMatchBoost = value;
            await this.plugin.saveSettings();
          });
      });

    // Filename Bonus setting
    new Setting(searchSettingGroup.settingItems)
      .setName(t('settings.filenameBonus'))
      .setDesc(t('settings.filenameBonusDesc'))
      .addSlider(slider => {
        slider
          .setLimits(0, 2, 0.1)
          .setValue(this.plugin.settings.search.scoring?.filenameBonus ?? 0.5)
          .setDynamicTooltip()
          .onChange(async value => {
            if (!this.plugin.settings.search.scoring) {
              this.plugin.settings.search.scoring = {};
            }
            this.plugin.settings.search.scoring.filenameBonus = value;
            await this.plugin.saveSettings();
          });
      });

    // Max Proximity Bonus setting
    new Setting(searchSettingGroup.settingItems)
      .setName(t('settings.maxProximityBonus'))
      .setDesc(t('settings.maxProximityBonusDesc'))
      .addSlider(slider => {
        slider
          .setLimits(0, 10, 0.5)
          .setValue(this.plugin.settings.search.scoring?.maxProximityBonus ?? 5.0)
          .setDynamicTooltip()
          .onChange(async value => {
            if (!this.plugin.settings.search.scoring) {
              this.plugin.settings.search.scoring = {};
            }
            this.plugin.settings.search.scoring.maxProximityBonus = value;
            await this.plugin.saveSettings();
          });
      });
    ...
    new Setting(searchSettingGroup.settingItems)
      .setName(t('settings.proximityThreshold'))
      .setDesc(t('settings.proximityThresholdDesc'))
      .addText(text => {
        text
          .setPlaceholder('20')
          .setValue(String(this.plugin.settings.search.scoring?.proximityThreshold ?? 20))
          .onChange(async value => {
            const numValue = Number(value);
            if (!isNaN(numValue) && numValue > 0) {
              if (!this.plugin.settings.search.scoring) {
              ...
              this.plugin.settings.search.scoring.proximityThreshold = numValue;
              await this.plugin.saveSettings();
            }
          });
    ...
    // BM25 k1 setting
    new Setting(searchSettingGroup.settingItems)
      .setName(t('settings.bm25K1'))
      .setDesc(t('settings.bm25K1Desc'))
      .addSlider(slider => {
        slider
          .setLimits(0.5, 3, 0.1)
          .setValue(this.plugin.settings.search.scoring?.bm25K1 ?? 1.5)
          .setDynamicTooltip()
          .onChange(async value => {
            if (!this.plugin.settings.search.scoring) {
              this.plugin.settings.search.scoring = {};
            }
            this.plugin.settings.search.scoring.bm25K1 = value;
            await this.plugin.saveSettings();
          });
      });
    ...
    // BM25 b setting
    new Setting(searchSettingGroup.settingItems)
      .setName(t('settings.bm25B'))
      .setDesc(t('settings.bm25BDesc'))
      .addSlider(slider => {
        slider
          .setLimits(0, 1, 0.05)
          .setValue(this.plugin.settings.search.scoring?.bm25B ?? 0.75)
          .setDynamicTooltip()
          .onChange(async value => {
            if (!this.plugin.settings.search.scoring) {
              this.plugin.settings.search.scoring = {};
            }
            this.plugin.settings.search.scoring.bm25B = value;
            await this.plugin.saveSettings();
          });
      });
  }
