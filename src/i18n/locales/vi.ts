const vi = {
	translation: {
		...
		ui: {
			...
			errorBuildingSearchIndex: 'Lỗi khi xây dựng chỉ mục tìm kiếm. Kiểm tra bảng điều khiển để biết chi tiết.',
			buildingIndexes: 'Steward: Đang xây dựng chỉ mục...',
			noActiveEditor: 'Không có trình soạn thảo nào đang hoạt động để đóng cuộc trò chuyện: {{conversationTitle}}',
			...
			errorBuildingInitialIndexes: 'Steward: Lỗi khi xây dựng chỉ mục ban đầu. Kiểm tra bảng điều khiển để biết chi tiết.',
			...
			welcomeMessage: 'Chào mừng đến với trò chuyện Steward luôn sẵn sàng. Gõ bên dưới để tương tác.',
		},
		// Conversation states
		conversation: {
